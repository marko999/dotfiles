...
alias v='fd . ~/repos --type f --hidden --exclude .git | fzf-tmux -p --reverse | xargs nvim'
alias otmx='nvim ~/.config/tmux/.tmux.conf'
...
PROMPT_OS_AND_KERNEL="%K{$bg2}%F{$fg2} %(!.%K{red}%F{$bg2}.%K{$bg3}%F{$bg2})"
